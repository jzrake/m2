...
function m2Application:__init__(args)
   ...
   local periods = {0, 0, 0}
   local bc_upper = args.bc_upper or {'open', 'open', 'open'}
   local bc_lower = args.bc_lower or {'open', 'open', 'open'}
   ...
   for n=1,3 do
      self._m2.boundary_condition_upper[n] = to_enum('boundary_'..bc_upper[n])
      self._m2.boundary_condition_lower[n] = to_enum('boundary_'..bc_lower[n])
